...
class MemberController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('MemberBundle:member:new.html.twig', array(
            'member' => $member,
    ...
    public function showAction(Member $member)
    {
        ...
        return $this->render('MemberBundle:member:show.html.twig', array(
            'member' => $member,
    ...
    public function editAction(Request $request, Member $member)
    {
        ...
        return $this->render('MemberBundle:member:edit.html.twig', array(
            'member' => $member,
